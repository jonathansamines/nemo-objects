...
function countProperty(nemo, control, descriptor) {
  /**
   * Creates a function that when called
   * counts the number of elements found with the specified locator
   * @example
